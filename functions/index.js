...
function processV1Request (request, response) {
  ...
  var dataBase = [ 
    {question:"What does umbrella mean?",options:["tenedor","paraguas","reloj"],correct:"paraguas"} ,
  ];
  global.questionS = dataBase[0];
...
//        sendGoogleResponse([questionS.question,questionS.options]); // Send simple response to user
    ...
    'answer.value': () => {
      ...
      if (requestSource === googleAssistantRequest) {
        ...
        sendResponse(respuesta); // Send simple response to user
      }
    },
